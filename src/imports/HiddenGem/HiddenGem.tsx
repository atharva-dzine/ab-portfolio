import imgScreenshot20260407At101525Am1 from "./1c5e3da369e9aeadb179f74dd771ac2896ebc408.png";
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-white w-full">
        <p className="leading-[32px]">Hidden Gem</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start pb-[0.745px] pt-[3px] relative shrink-0 w-full" data-name="Paragraph">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#ababab] text-[14px] w-[325.591px]">
        <p className="leading-[20px]">A discovery platform that connects travelers with locals to explore authentic, lesser-known experiences.</p>
      </div>
    </div>
  );
}
...
export default function HiddenGem() {
  return (
    <div className="bg-[#191919] relative rounded-[24px] size-full" data-name="hidden gem">
      ...
      <Container />
      <div className="absolute flex h-[339.091px] items-center justify-center left-[16.36px] top-[20px] w-[415.455px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none scale-x-91 scale-y-91">
          <div className="h-[373px] relative rounded-[15px] w-[457px]" data-name="Screenshot 2026-04-07 at 10.15.25 AM 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[15px] size-full" src={imgScreenshot20260407At101525Am1} />
          </div>
        </div>
      </div>
    </div>
